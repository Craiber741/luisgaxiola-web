...
import { ArrowRight, Check, Scissors, UtensilsCrossed, Building2, ChevronLeft, AlertTriangle, ExternalLink } from "lucide-react";
...
const SITES = [
  {
    ...
    icon: Scissors,
    desc: "Hero cinematográfico, servicios con precios, galería, testimoniales, widget de WhatsApp y agenda de citas.",
    href: "/web2",
  },
  {
    available: false,
    ...
    desc: "Menú digital, reservaciones, galería de platillos, horarios y mapa de ubicación.",
    href: "#",
  },
  {
    available: false,
    ...
    icon: Building2,
    desc: "Landing de alta conversión para clínicas, despachos, consultoras y más.",
    href: "#",
  },
];
